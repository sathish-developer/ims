...
<!-- 						</select> -->
			  ...
			  <div style = "color:red" ng-show = "frgmyform.$submitted || frgmyform.secretanswer.$touched" class="error_msg">
					...
					<div class="wrap-input100 validate-input tooltip_codition" data-validate="Password is required" class="error_msg">
						<input class="input100 input_condition" type="password" name="newPassword" id="newPassword" data-ng-model='userDto.newPassword' required placeholder="New Password" maxlength="{{passwordRulesDto.minLengthForRegularPassword}}">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
			  ...
			  <div style = "color:red" ng-show = "frgmyform.$submitted || frgmyform.newPassword.$touched" class="error_msg">
					...
					<div class="wrap-input100 validate-input tooltip_codition" data-validate="Password is required" class="error_msg">
						<input class="input100 input_condition" type="password" name="confirmPassword" id="confirmPassword" data-ng-model='userDto.confirmPassword' required placeholder=" Confirm Password" maxlength="{{passwordRulesDto.minLengthForRegularPassword}}">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
