  ...
  var AdminMenu = function ($) {
    ...
    var AdminMenu = function () {
      ...
      AdminMenu.prototype.init = function init() {
        var self = this;
        // $(this._element).find(this._config.parentTrigger + '.' + this._config.activeClass).attr('aria-expanded', false).addClass(this._config.collapseClass + ' ' + this._config.collapseInClass);
