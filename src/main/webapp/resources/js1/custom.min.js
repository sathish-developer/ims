$(function() {
    ...
    }), $( ".buttom-side-toggle" ).click(function() {
        $( "div.bottom-sidebar" ).toggleClass( "showbottom" );
    }); $("#main-wrapper").click(function() {
        $("div.bottom-sidebar").removeClass("showbottom");
    }),
	...
	//$('.add_input_span label').after('<p class="new_asterisk"></p>');
});